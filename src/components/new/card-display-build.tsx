...
const CardDisplayBuild = ({ build }: any) => {
	...
	return (
		<Card
			...
			className={cn(
				"flex flex-1 min-w-[200px] min-w-xs max-w-xs w-full group/card select-none cursor-pointer overflow-hidden relative card h-52 rounded-md shadow-xl backgroundImage flex-col justify-between p-4",
