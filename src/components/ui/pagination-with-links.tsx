...
export function PaginationWithLinks({
    ...
    const renderPageNumbers = () => {
        ...
        if (totalPageCount <= maxVisiblePages) {
            for (let i = 1; i <= totalPageCount; i++) {
                items.push(
                    <PaginationItem key={i} className="bg-black border-none ">
                        <PaginationLink
                            href={buildLink(i)}
                            isActive={page === i}
                        >
    ...
    return (
        <div className="flex flex-row items-center gap-3 h-full">
            ...
            >
                <PaginationContent className="max-sm:gap-0 h-full">
                    <PaginationItem className="bg-black border-none h-full">
                        <PaginationPrevious
                    ...
                    {/* {renderPageNumbers()} */}
                    <div className="px-3 tracking-widest bg-black border-none h-full items-center flex">
                        <TypographyMuted str={`${page}/${totalPageCount}`} />
                    </div>
